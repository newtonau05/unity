...
Shader "Forceling/World Grid"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult33 = lerp( triplanar10 , lerp(triplanar10,( saturate( (( blendOpDest17 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest17 - 0.5 ) ) * ( 1.0 - blendOpSrc17 ) ) : ( 2.0 * blendOpDest17 * blendOpSrc17 ) ) )),_Use10m) , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 13.0 ) , 15.0 ) ));
			...
			float4 lerpResult42 = lerp( lerpResult33 , lerp(lerp(triplanar10,( saturate( (( blendOpDest17 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest17 - 0.5 ) ) * ( 1.0 - blendOpSrc17 ) ) : ( 2.0 * blendOpDest17 * blendOpSrc17 ) ) )),_Use10m),( saturate( (( blendOpDest31 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest31 - 0.5 ) ) * ( 1.0 - blendOpSrc31 ) ) : ( 2.0 * blendOpDest31 * blendOpSrc31 ) ) )),_Use100m) , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 80.0 ) , 10.0 ) ));
...
/*ASEBEGIN
Version=15900
2567;292;1906;1010;2191.205;-486.4189;1;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;21;-2143.046,18.90407;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceCameraPos;22;-2186.046,243.9039;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DistanceOpNode;23;-1756.046,128.9039;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;35;-2179.858,683.1163;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceCameraPos;34;-2222.858,908.1161;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;15;-2085.078,-747.2676;Float;False;Constant;_Float2;Float 2;3;0;Create;True;0;0;False;0;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-2086.453,-339.6314;Float;False;Constant;_Float1;Float 1;2;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-2069.97,-1067.516;Float;False;Constant;_Float3;Float 3;3;0;Create;True;0;0;False;0;0.005;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;36;-1792.858,793.1162;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;39;-658.274,757.7598;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=99742F267D29F80CBB16D9BD080C27EC1AD847BA